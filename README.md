...
- The robot: skid-steer base (stands in for tracks), a prismatic lift deck with a tilting
  top, a front camera, and a 60 kg cedar stack held by a detachable joint.
